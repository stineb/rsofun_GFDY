...
Fluxnet <- read_csv("~/rsofun_GFDY/data/raw_mod/FLX_CH-Lae_FLUXNET2015_FULLSET_YY_2004-2014_1-3.csv")
...
## Target 2. LAI ####
lai_LAE <- read_csv("~/rsofun_GFDY/data/raw_mod/MODIS_LAI_MCD15A3H_daily_CH-Lae.csv")
...
LAE_data <- read_csv("~/rsofun_GFDY/data/raw_mod/20201216_Laegeren_data.csv")
...
save(ddf_obs, file = "~/rsofun_GFDY/data/inputs_mod/ddf_obs.RData")
...
save(settings_calib_DBH_gs, file = "~/rsofun_GFDY/data/inputs_mod/settings_calib_DBH_gs_uniq_euler.RData")
...
save(settings_calib_GR_gs, file = "~/rsofun_GFDY/data/inputs_mod/settings_calib_GR_gs_uniq_euler.RData")
