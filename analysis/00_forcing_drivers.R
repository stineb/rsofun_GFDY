...
# Meteo data ####
FLX_HH_LAE <- read_csv("~/rsofun_GFDY/data/raw_mod/FLX_CH-Lae_FLUXNET2015_FULLSET_HH_2004-2014_1-3.csv") %>%
...
save(forcingLAE, file = "~/rsofun_GFDY/data/inputs_mod/forcingLAE.RData")
